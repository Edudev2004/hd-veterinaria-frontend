...
import { Bell, LogOut, ShieldCheck, Stethoscope, User as UserIcon } from 'lucide-react';
    ...
    <>
      ...
      <header className="sticky top-0 bg-[#f8fafc]/90 backdrop-blur-md border-b border-slate-200/60 z-30 px-4 sm:px-8 py-3.5 flex items-center justify-between transition-all">
        ...
        <div className="flex items-center gap-3 sm:gap-4">
          ...
          <button
            className="relative p-2 text-slate-600 hover:text-slate-900 hover:bg-slate-200/60 rounded-full transition-all cursor-pointer"
